...
sprinkler_switch_table = dynamodb.create_table(
    TableName='sprinkler_switch',
...
sprinkler_switch_table.meta.client.get_waiter('table_exists').wait(TableName='sprinkler_switch')
